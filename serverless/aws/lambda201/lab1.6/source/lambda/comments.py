...
def get(event, context):
    ...
    # Add Name/Comment to the items - We could do this in the webhook function more appropriately
    # For demonstrations this is is effective since we can call it directly
    modified_items = []
    for item in items:
